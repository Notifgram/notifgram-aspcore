...
public class DefaultInfrastructureModule : Module
{
  ...
  public DefaultInfrastructureModule(bool isDevelopment, Assembly? callingAssembly = null)
  {
    ...
    var coreAssembly =
      Assembly.GetAssembly(typeof(Channel)); // TODO: Replace "Project" with any type from your Core project
  ...
  private void RegisterCommonDependencies(ContainerBuilder builder)
  {
    ...
    builder.RegisterType<EmailRequestsHandler>()
      .As<IEmailRequestsHandler>()
      .InstancePerLifetimeScope();
    ...
    builder.RegisterType<FcmTokenVerifier>()
      .As<IFcmTokenVerifier>()
      .InstancePerLifetimeScope();
